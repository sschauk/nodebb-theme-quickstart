...
<div component="post/footer" class="post-footer border-bottom pb-2">
	...
	<div component="post/actions" class="d-flex justify-content-end gap-1 post-tools">
		...
		<!-- New Pin Button -->
		<!-- generated by chatgpt request to create a pin button -->
		{{{ if privileges.isAdminOrMod }}}
			<a component="post/pin" href="#" class="btn-ghost-sm" title="[[topic:pin-post]]">
				<i class="fa fa-thumbtack text-primary"></i>
			</a>
		{{{ end }}}
